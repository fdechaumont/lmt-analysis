...
def reBuildEvent( connection, file, tmin=None, tmax=None, pool = None ): 
    ...
    for animal in pool.animalDictionnary.keys():
        ...
        for t in dicA.keys():
            ...
            if (dicA[t].getDistanceToPoint(xPoint = 398, yPoint = 353) <= animalA.parameters.MAX_DISTANCE_TO_POINT*2):
            ...
            if (dicA[t].getDistanceToPoint(xPoint = 398, yPoint = 353) <= animalA.parameters.MAX_DISTANCE_TO_POINT):
        ...
        waterStopTimeLine.removeEventsBelowLength( maxLen = animalA.parameters.MIN_WATER_STOP_DURATION )    
