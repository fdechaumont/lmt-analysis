...
def isSideBySide( animalA, detA, detB ):
    ...
    if distHeadBack( detA, detB ) > animalA.parameters.MAX_DISTANCE_HEAD_HEAD_GENITAL_THRESHOLD*2:
        return False

    if distHeadBack( detB, detA ) > animalA.parameters.MAX_DISTANCE_HEAD_HEAD_GENITAL_THRESHOLD*2:
        return False
