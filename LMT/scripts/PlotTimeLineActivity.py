...
def plotNightTimeLine ( file ):
    ...
    for nightEvent in nightTimeLine.getEventList():
        ...
        ax.text( nightEvent.startFrame+(nightEvent.endFrame-nightEvent.startFrame)/2 , 180 , "dark phase" ,fontsize=8,ha='center')
...
if __name__ == '__main__':
    ...
    for file in files:
        ...
        for nightEvent in nightTimeLine.getEventList():
            ax.axvspan( nightEvent.startFrame, nightEvent.endFrame, alpha=0.1, color='black')
            ax.text( nightEvent.startFrame+(nightEvent.endFrame-nightEvent.startFrame)/2 , 140 , "dark phase" ,fontsize=6,ha='center')
